-- The refresh token's own wrapped key. PostgreSQL.
--
...
ALTER TABLE jira_connection ADD COLUMN refresh_wrapped_dek BYTEA;
ALTER TABLE jira_connection ADD COLUMN refresh_kek_id VARCHAR(128);
