-- The refresh token's own wrapped key. Oracle.
--
...
ALTER TABLE jira_connection ADD refresh_wrapped_dek BLOB ;
ALTER TABLE jira_connection ADD refresh_kek_id VARCHAR2(128);
