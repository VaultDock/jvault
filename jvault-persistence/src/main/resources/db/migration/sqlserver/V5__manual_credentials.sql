-- The identity a manually imported credential authenticates as. Microsoft SQL Server.
--
...
ALTER TABLE jira_connection ADD auth_email NVARCHAR(320);
...
ALTER TABLE jira_connection ADD credential_kind NVARCHAR(24) NOT NULL DEFAULT 'OAUTH';
